...
class Settings(object):
    def __init__(self, settings_file_path, run_type,
                 run_dir, verbose):
        self.json = self.load_settings_file(fp)
    ...
    class AssistantSettings(Settings):
        def __init__(self, state, run_category, settings_file_path,
            ...
            run_category_settings = state_settings[run_type]
            ...
            self.max_page_number = run_category_settings['max_page_number']
